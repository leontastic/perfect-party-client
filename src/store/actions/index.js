...
export const setSearchProductString = createStandardAction('@FORMS/SEARCH_PRODUCT/SET_PRODUCT_STRING')()
...
export const clearCart = createStandardAction('@CART/CLEAR')()
